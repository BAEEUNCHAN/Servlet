...
<div class="container reply">
	<!-- 등록 -->
	<div class="col-sm-8">
		<input class="col-sm-7" type="text" id="content">
		<button class="col-sm-2" id="addReply">댓글등록</button>
	</div>
	<!-- 목록 -->
	<div class="content">
		<ul id="replyList">
			<li><span class="col-sm-2"></span> <span class="col-sm-5">댓글내용</span>
				<span class="col-sm-2">작성자</span> <span class="col-sm-2"><button>삭제</button></span>
			</li>
		</ul>
	</div>
	<!-- 댓글 페이징 -->
